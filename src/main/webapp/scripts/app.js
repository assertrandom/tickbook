...
var tickbookApp = angular.module('tickbookApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'tickbookAppUtils', 'pascalprecht.translate', 'truncate']);
